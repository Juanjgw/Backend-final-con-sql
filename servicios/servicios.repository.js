...
const insertarServicio = async ({title, description, contactNumber, rating}) => {
    try{
        const consultaString = 'INSERT INTO Servicios (title, description, contactNumber, rating) VALUES (?,?,?,?)'
        const valores = [title, description, contactNumber, rating]
...
const seleccionarServicios = async () =>{
    try{
...
module.exports = { insertarServicio, seleccionarServicioPorId, deleteServicioPorId, seleccionarServicios}